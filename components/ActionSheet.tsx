    ...
    <>
      <div className="fixed inset-0 z-50 flex items-end justify-center">
        ...
        <div className="relative w-full max-w-lg bg-white rounded-t-3xl shadow-2xl p-6 animate-slide-up pb-safe flex flex-col">
          ...
          <div className="mb-6 overflow-y-auto max-h-[60vh] hide-scrollbar">
            {loading ? (
          ...
          {error && (
            <div className="p-4 bg-red-50 text-red-600 text-xs rounded-xl border border-red-100 text-center font-medium">
              {error}
            </div>
          )}
        </div>
